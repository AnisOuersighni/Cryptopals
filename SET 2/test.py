...
from ECB_decryption_Byte_at_a_time12 import  find_unknown_string_size_from_cipher, brute_force_one_byte_each_time
...
class Oracle:
    def __init__(self):
        self.key = urandom(16)
        self.prefix = urandom(randint(1,15))
    ...
    def encrypt(self, message):
        return ecb_encrypt_aes_128_block(
